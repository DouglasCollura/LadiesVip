...
export class InformacionPersonalComponent implements OnInit {
    ...
    CargarImagen(event: any) {
        ...
        this.user_imagen_show = formData;
        this.data = formData;
        this.UpdateUser();
    ...
    UpdateUser():any{
        ...
        this.UserService.UpdateUser(this.data).then(res=>{
            ...
            if(sessionStorage.getItem("usuario")){
                ...
                sessionStorage.setItem("usuario",JSON.stringify(this.datos))
            }else{
    ...
    filtrarSelect(id:any,tipo:any){
        ...
        if(tipo == 1){
            res = this.ctrl_identidad.filter( (res:any) => res == id);
        }
        if(tipo == 3){
            res = this.ctrl_servicios.filter( (res:any) => res == id);
