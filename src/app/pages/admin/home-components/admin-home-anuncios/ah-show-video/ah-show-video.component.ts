...
@Component({
    selector: 'app-ah-show-video',
    templateUrl: './ah-show-video.component.html',
    styleUrls: ['./ah-show-video.component.scss']
})
export class AhShowVideoComponent implements OnInit {
    ...
    Muted(){
        if($('#video_here')[0].muted){
            ...
            $(".btn-volume").find('imagenes')[0].src='../../../../assets/img/muted.svg'
