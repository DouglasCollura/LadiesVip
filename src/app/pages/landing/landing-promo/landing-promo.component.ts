...
import { CreateMarketService } from '../../admin/market-components/admin-market-publicados/create-market/create-market.service';
import { NegociosService } from 'src/app/services/negocios/negocios.service';
declare var $: any;

@Component({
    selector: 'app-landing-promo',
...
export class LandingPromoComponent implements OnInit {
    ...
    CrearNegocio(){
        ...
        this.loading=true;
        this.NegociosService.CrearNegocioPromo(this.formData).then(res=>{
            this.Limpiar()
            this.loading=false;
            this.end=true;
            setTimeout(()=>{
    ...
    Close(){
        ...
        this.fase = 0;
        this.Limpiar();
        this.CreateMarketService.negocio=null;
